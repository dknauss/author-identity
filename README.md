...
| Work Packages | [wp-01.md](implementation-strategy/wp-01.md) to [wp-06.md](implementation-strategy/wp-06.md): Detailed delivery specs by package<br>[gap-analysis.md](implementation-strategy/gap-analysis.md): Audit of code against the specs<br>[implementation-spec.md](implementation-strategy/implementation-spec.md): Supplemental strategy details and cross-cutting concerns<br>[code-review-plan.md](implementation-strategy/code-review-plan.md): Post-Gate-A hardening backlog from source/test review |
| Legacy | [byline-rss-spec-adoption/](byline-rss-spec-adoption/): Earlier planning and legacy positioning documents |
